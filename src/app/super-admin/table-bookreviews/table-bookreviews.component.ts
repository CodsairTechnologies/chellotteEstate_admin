...
@Component({
  selector: 'app-table-bookreviews',
  standalone: true,
  imports: [TableComponent,
    ...
    DialogModule,
    AvatarModule,
    CommonModule], templateUrl: './table-bookreviews.component.html',
  styleUrl: './table-bookreviews.component.css'
})
export class TableBookreviewsComponent {
  token: any;
  adminid: any;
  userName: any;
  status: any;
  ...
  arrColumns: any = [
    ...
    { strHeader: "Book Name", strAlign: "center", strKey: "booktitle", field: "booktitle" },
    { strHeader: "Reviewer Name", strAlign: "center", strKey: "reviewername", field: "reviewername" },
    // { strHeader: "Reviewed Date", strAlign: "center", strKey: "uploaddate", field: "uploaddate" },
  ...
  getTableFn() {
    this.Loader = true;
    this.objApiService.handleApiCall('/api/admin/getbookreview/', { id: 'sample' }, (res) => {
      this.Loader = false;
 ...
 */
  deleteFn() {
    ...
    this.Loader = true;
    this.objApiService.handleApiCall('/api/admin/deletebookreview/', { id: this.ID }, (res) => {
      this.Loader = false;
 ...
 */
  toggleActiveInactive(id: number, status: string) {
    this.Loader = true;
    this.objApiService.handleApiCall('/api/admin/updatebookreviewstatus/', { id, status }, (res) => {
      this.Loader = false;
      if (res.response === 'Success') {
        this.showSuccess(res.message);
        this.getTableFn();
  ...
  eventFromTable(objEvent: any) {
    switch (objEvent.strOperation) {
      case 'EDIT_DATA':
        ...
        this.router.navigate(['/super-admin/bookreviews'], {
      ...
      case 'SINGLEVIEW_DATA':
        ...
        this.router.navigate(['/super-admin/viewbookreviews'], {
          queryParams: { id: id },
        });
  ...
  naviagteTo() {
    this.router.navigateByUrl('/super-admin/bookreviews')
  }
