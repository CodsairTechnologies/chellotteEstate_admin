...
@Component({
  ...
  imports: [TableComponent,
    ...
    CommonModule,
    SafeHtmlPipe],
  templateUrl: './view-novels.component.html',
  styleUrl: './view-novels.component.css'
})
export class ViewNovelsComponent {
  ...
  getPoemByIdFn(id: string) {
    ...
    this.objApiService.handleApiCall(
      ...
      (res) => {
        ...
        if (res.response === 'Success' && res.novel) {
          const review = res.novel;
