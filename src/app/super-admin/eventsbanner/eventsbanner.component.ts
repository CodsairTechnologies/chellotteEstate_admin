...
@Component({
  ...
  styleUrl: './eventsbanner.component.css'
})
...
token: any;
   ...
   */
getTableFn() {
  this.objApiService.handleApiCall('/api/admin/geteventbanners/', { id: 'sample' }, (res) => {
 ...
 */
  ...
  modalHeader: string = 'Add Event Banner';
  openCategoryModal(isEdit: boolean, id?: string) {
    this.modalHeader = 'Add Event Banner';
  ...
  getCategoryById(id: string) {
    this.modalHeader = 'Edit Event Banner';
    this.id = id;
    this.Loader = true;

    this.objApiService.handleApiCall('/api/admin/geteventbannerbyid/', { id: this.id }, (response) => {
      this.Loader = false;
  ...
  handleCategoryOperation() {
    ...
    this.objApiService.handleApiCall('/api/admin/addediteventbanner/', formData, (response) => {
      this.Loader = false;
 ...
 */
  deleteFn() {
    ...
    this.objApiService.handleApiCall('/api/admin/deleteeventbanner/', { id: this.ID }, (res) => {
 ...
 */
  toggleActiveInactive(id: number, status: string) {
    this.objApiService.handleApiCall('/api/admin/updateeventbannerstatus/', { id, status }, (res) => {
      if (res.response === 'Success') {
        this.showSuccess(res.message);
        this.getTableFn();
