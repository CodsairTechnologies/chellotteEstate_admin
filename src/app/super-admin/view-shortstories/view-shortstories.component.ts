...
@Component({
  selector: 'app-view-shortstories',
  standalone: true,
  imports: [TableComponent,
    ...
    CommonModule,
    SafeHtmlPipe],
  templateUrl: './view-shortstories.component.html',
  styleUrl: './view-shortstories.component.css'
})
export class ViewShortstoriesComponent implements OnInit {
  ...
  //     '/api/user/getshortstorybyid/',
  //     { id: id },
  //     (res) => {
  //       console.log('API response:', res); // Debug
  //       if (res.response === 'Success' && res.shortstory) {
  //         const review = res.shortstory;
  //         this.poems = [{
  //           banner: this.getImageUrl(review.bookcoverimage),
  ...
  //           paragraphs: this.sanitizer.bypassSecurityTrustHtml(review.content || 'No content available.')
  //         }];
  //         console.log('poemDetails:', this.poemDetails); // Debug
  //       } else {
